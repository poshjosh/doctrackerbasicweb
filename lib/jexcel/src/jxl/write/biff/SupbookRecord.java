...
class SupbookRecord extends WritableRecordData
{
   ...
   * The logger
   */
  private static Logger logger = Logger.getLogger(SupbookRecord.class.getName());
  ...
  public SupbookRecord(jxl.read.biff.SupbookRecord sr, WorkbookSettings ws)
  {
    ...
    {
      logger.warning("Supbook type is addin");
    }
  }
  ...
  public byte[] getData()
  {
    ...
    {
      logger.warning("unsupported supbook type - defaulting to internal");
      initInternal();
    }
