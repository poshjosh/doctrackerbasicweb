  ...
  implements ExternalSheet, WorkbookMethods
{
   ...
   * The logger
   */
  private static Logger logger = Logger.getLogger(WritableWorkbookImpl.class.getName());
  /**
                              ...
                              WorkbookSettings ws) throws IOException
  {
    ...
    if (wp.getExternalSheetRecord() != null)
    {
      ...
      for (int i = 0; i < readsr.length; i++)
      {
        ...
        else
        {
          ...
          {
            logger.warning("unsupported supbook type - ignoring");
          }
        }
      }
    }
    ...
    if (!settings.getNamesDisabled())
    {
      ...
      for (int i = 0; i < na.length; i++)
      {
        ...
        {
          logger.warning("Cannot copy Biff7 name records - ignoring");
        }
      }
    }
  ...
  public void write() throws IOException
  {
    ...
    if (countryRecord == null)
    {
      ...
      {
        logger.warning("Unknown country code " + 
  ...
  public String getExternalSheetName(int index)
  {
    ...
    logger.warning("Unknown Supbook 1");
    return "[UNKNOWN]";
  }
  ...
  public String getLastExternalSheetName(int index)
  {
    ...
    // An unknown supbook - return unkown
    logger.warning("Unknown Supbook 2");
    return "[UNKNOWN]";
  }
  ...
  public int getExternalSheetIndex(String sheetName)
  {
    ...
    if (found)
    {
      ...
      {
        logger.warning("Cannot find sheet " + sheetName + " in supbook record");
      }
    ...
    {
      logger.warning("Square brackets");
      return -1;
    }
  ...
  public void removeRangeName(String name)
  {
    ...
    if (found)
    {
      ...
      {
        logger.warning("Could not remove " + name + " from index lookups");
      }
    }
  }
