...
public class FormattingRecords
{
   ...
   * The logger
   */
  private static Logger logger = Logger.getLogger(FormattingRecords.class.getName());
    ...
    throws NumFormatRecordsException
  {
    ...
    {
      logger.warning("Format index exceeds Excel maximum - assigning custom " +
                  "number");
                                  ...
                                  IndexMapping formatMapping)
  {
    ...
    {
      logger.warning("There are less than the expected minimum number of " +
                   "XF records");
      return mapping;
    }
  ...
  public IndexMapping rationalizeDisplayFormats()
  {
    ...
    while (i.hasNext())
    {
      ...
      if (!duplicate)
      {
        ...
        {
          logger.warning("Too many number formats - using default format.");
