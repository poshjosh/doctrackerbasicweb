...
public class BaseCellFeatures
{
   ...
   * The logger
   */
  public static Logger logger = Logger.getLogger(BaseCellFeatures.class.getName());
  ...
  public void setDataValidationList(Collection c)
  {
    ...
    {
      logger.warning("Cannot set data validation on " + 
                  CellReferenceHelper.getCellReference(writableCell) + 
  ...
  */
  ...
  public void shareDataValidation(BaseCellFeatures source)
  {
    if (dataValidation)
    {
      logger.warning("Attempting to share a data validation on cell " + 
                  CellReferenceHelper.getCellReference(writableCell) + 
