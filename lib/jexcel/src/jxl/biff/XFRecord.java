...
public class XFRecord extends WritableRecordData implements CellFormat
{
   ...
   * The logger
   */
  private static Logger logger = Logger.getLogger(XFRecord.class.getName());
  ...
  public XFRecord(Record t, WorkbookSettings ws, BiffType bt)
  {
        ...
        (parentFormat & 0xfff) == 0xfff)
    {
      ...
      parentFormat = 0;
      logger.warning("Invalid parent format found - ignoring");
    }
  ...
  public final void uninitialize()
  {
    ...
    if (initialized == true)
    {
      logger.warning("A default format has been initialized");
    }
    initialized = false;
  }
